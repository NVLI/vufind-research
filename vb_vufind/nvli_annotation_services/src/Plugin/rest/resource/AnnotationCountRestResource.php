 ...
 *
 * @RestResource(
 *   id = "annotation_count_rest_resource",
 *   label = @Translation("Annotation count rest resource"),
 *   uri_paths = {
 *     "canonical" = "/nvli/count"
 *   }
 * )
 */
class AnnotationCountRestResource extends ResourceBase {
