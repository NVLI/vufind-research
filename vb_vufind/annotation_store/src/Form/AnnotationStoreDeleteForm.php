...
/**
 * Provides a form for deleting a annotation_store entity.
 *
 * @ingroup annotation_store
 */
class AnnotationStoreDeleteForm extends ContentEntityConfirmFormBase {
  ...
  public function getCancelURL() {
    return new Url('entity.annotation_store_entity.collection');
  }
